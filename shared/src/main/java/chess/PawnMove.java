        ...
        if (piece.getPieceType() == ChessPiece.PieceType.PAWN) {
            ...
            if (board.isInBounds(nextPosition)) {
                ...
                if (board.isInBounds(diagonallyRight)) {
                    ...
                    if (rightDiagonalPiece != null && rightDiagonalPiece.getTeamColor() != pawn.getTeamColor()) {
                ...
                if (board.isInBounds(diagonallyLeft)) {
                    ...
                    if (leftDiagonalPiece != null && leftDiagonalPiece.getTeamColor() != pawn.getTeamColor()) {
